			...
			<ScrollArea className="h-full flex-1 bg-gray-100 w-full">
				<div className="flex-1 space-y-4 p-10">
					...
					<div className="grid grid-cols-3 grid-rows-4 gap-4">
						...
						<Card className="row-span-3 col-span-2 flex flex-col">
							<CardHeader>
								<CardTitle className="text-lg">Expenses</CardTitle>
								<CardDescription>{format(today, "MMMM, yyyy")}</CardDescription>
							</CardHeader>
							<CardContent className="flex-1 pb-0 ">
								<DashboardExpenseChart transactionsData={monthlyData} />
							</CardContent>
							<CardFooter className="text-sm leading-none text-muted-foreground justify-center">
