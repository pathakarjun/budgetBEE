      ...
      <Card className="flex flex-col w-1/2">
            ...
            {incomeChartData.length > 0 ? (
              ...
              <div className="flex items-center w-full h-full justify-center">
                <div className="text-sm leading-none text-muted-foreground text-center">
                  No income added for {format(today, "MMM, yyyy")}
                </div>
              </div>
            )}
          </ChartContainer>
        ...
        {incomeChartData.length > 0 && (
          <CardFooter className="text-sm leading-none text-muted-foreground justify-center text-center">
            Showing income for {format(today, "MMM, yyyy")}
          </CardFooter>
        )}
      </Card>
      <Card className="flex flex-col w-1/2">
        ...
        <CardContent className="flex-1 pb-0">
          <ChartContainer config={expenseChartConfig} className="w-full h-full">
            {expenseChartData.length > 0 ? (
              ...
              <div className="flex items-center w-full h-full justify-center">
                <div className="text-sm leading-none text-muted-foreground text-center">
                  No expenses added for {format(today, "MMM, yyyy")}
                </div>
              </div>
            )}
          </ChartContainer>
        ...
        {expenseChartData.length > 0 && (
          <CardFooter className="text-sm leading-none text-muted-foreground justify-center text-center">
            Showing expenses for {format(today, "MMM, yyyy")}
          </CardFooter>
        )}
      </Card>
    </div>
